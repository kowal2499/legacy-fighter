...
class ValidateDriverLicenseIntegrationTest extends KernelTestCase
{
    ...
    {
        return $this->driverService->createDriver($license, 'Kowalski', 'Jan',
            Driver::TYPE_REGULAR, Driver::STATUS_ACTIVE, 'photo');
    }

    private function createInactiveDriverWithLicense(string $license): Driver
    {
        return $this->driverService->createDriver($license, 'Kowalski', 'Jan',
            Driver::TYPE_REGULAR, Driver::STATUS_INACTIVE, 'photo');
    }
